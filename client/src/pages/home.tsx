              ...
              <div className="gallery-card group">
                ...
                <div className="relative bg-white p-4 rounded-3xl shadow-2xl group-hover:shadow-3xl transition-shadow duration-500">
                  <div className="relative overflow-hidden rounded-2xl">
                    <img
                      ...
                      alt="Cluttered office space before cleaning"
                      className="w-full h-80 object-cover transition-all duration-700 group-hover:opacity-0"
                    />
                    <img
                      src="/assets/AdobeStock_334592268_1750505728985.jpeg"
                      alt="Organized office space after cleaning"
                      className="absolute inset-0 w-full h-80 object-cover opacity-0 transition-all duration-700 group-hover:opacity-100 brightness-110 contrast-110"
                    />
                    
                    {/* Organization Effect */}
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                      <div className="absolute top-1/3 left-1/4 w-4 h-1 bg-white/40 rounded-full animate-pulse"></div>
                      <div className="absolute top-1/2 right-1/3 w-3 h-1 bg-white/40 rounded-full animate-pulse" style={{animationDelay: '0.3s'}}></div>
                      <div className="absolute bottom-1/3 left-1/2 w-2 h-1 bg-white/40 rounded-full animate-pulse" style={{animationDelay: '0.6s'}}></div>
                    </div>
                ...
                <div className="mt-6 text-center bg-gradient-to-b from-gray-50 to-white p-8 rounded-2xl shadow-lg">
                  <div className="border-b border-gray-200 pb-4 mb-4">
                    ...
                    <p className="text-naestir-secondary leading-relaxed">
                      Cluttered workspaces transformed into productive environments with our systematic deep cleaning and organization service.
                    </p>
                  </div>
                  <div className="brand-signature opacity-0 group-hover:opacity-100 transition-all duration-1000 delay-700">
                    <div className="font-playfair text-2xl text-naestir-primary italic tracking-wider">
