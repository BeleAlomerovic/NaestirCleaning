        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="gallery-card group">
                ...
                <div className="mt-6 text-center bg-gradient-to-b from-gray-50 to-white p-8 rounded-2xl shadow-lg">
                  <div className="border-b border-gray-200 pb-4 mb-4">
                    ...
                    <p className="text-naestir-secondary leading-relaxed">
                      Deep-set stains and odors extracted using high-temperature steam cleaning and fabric-safe protective treatments.
                    </p>
                  </div>
                  <div className="brand-signature opacity-0 group-hover:opacity-100 transition-all duration-1000 delay-700">
                    <div className="font-playfair text-2xl text-naestir-primary italic tracking-wider">
            ...
            <div className="text-center mt-16">
              <div className="mb-8">
                <p className="text-xl text-naestir-secondary mb-6 max-w-2xl mx-auto">
                  Ready to see your own transformation? Let's make it happen.
                </p>
              </div>
              
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Link href="/quote">
                  <Button className="transformation-cta bg-gradient-to-r from-naestir-primary to-purple-600 hover:from-purple-600 hover:to-naestir-primary text-white px-10 py-4 text-lg font-semibold shadow-2xl hover:shadow-purple-500/25 transition-all duration-300">
                    Get Your Transformation Quote
                  </Button>
                </Link>
                <Link href="/booking">
                  <Button variant="outline" className="border-2 border-naestir-primary text-naestir-primary hover:bg-naestir-primary hover:text-white px-10 py-4 text-lg font-semibold transition-all duration-300">
                    Book Today
                  </Button>
                </Link>
              </div>
