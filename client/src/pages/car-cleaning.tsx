...
export default function CarCleaning() {
  ...
  const carImages = [
    {
      src: "data:image/svg+xml;base64,",
      alt: "Professional car cleaning result"
    },
    {
      src: "data:image/svg+xml;base64,",
        ...
        <section className="relative bg-gradient-to-br from-[#F8F6FB] via-white to-[#F0E6FF] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Complete automotive detailing services for both interior and exterior. 
                We bring your vehicle back to showroom condition with meticulous care and premium products.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[80vh]">
              ...
              <div className="lg:col-span-5 space-y-12 pr-8 border-r border-gray-100">
                ...
                <div>
                  ...
                  >
                    What's Included in Your Car Clean
                  </h2>
