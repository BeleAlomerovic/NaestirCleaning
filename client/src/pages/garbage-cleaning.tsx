...
export default function GarbageCleaning() {
  ...
  const garbageImages = [
    {
      src: "data:image/svg+xml;base64,",
      alt: "Professional garbage cleaning result"
    },
    {
      src: "data:image/svg+xml;base64,",
      alt: "Clean waste area"
    }
  ];

  const serviceFeatures = [
    "High-pressure washing and sanitization",
    "Odor elimination and deodorizing treatment",
    "Interior and exterior bin cleaning",
    "Eco-friendly disinfectant application",
    "Regular maintenance scheduling available",
    "Both residential and commercial service",
    "Waste area organization and cleanup",
  ...
  if (currentImageIndex >= garbageImages.length) {
        ...
        <section className="relative bg-gradient-to-br from-[#F8F6FB] via-white to-[#F0E6FF] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Professional Garbage Can Cleaning Services
              </h1>
              <p 
              ...
              >
                Hygienic cleaning and sanitization of waste containers to eliminate odors and bacteria. 
                We keep your bins fresh and sanitary with eco-friendly cleaning solutions and regular maintenance.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[80vh]">
              ...
              <div className="lg:col-span-5 space-y-12 pr-8 border-r border-gray-100">
                ...
                <div>
                  ...
                  >
                    What's Included in Your Garbage Clean
                  </h2>
