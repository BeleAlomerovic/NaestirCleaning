...
export default function CarpetCleaning() {
  ...
  const carpetImages = [
    {
      src: carpetImage,
      alt: "Professional carpet cleaning and sanitization service"
    },
    {
      src: logoImage, 
  ...
  const nextImage = () => {
    setCurrentImageIndex((prev) => (prev + 1) % carpetImages.length);
  };

  const prevImage = () => {
    setCurrentImageIndex((prev) => (prev - 1 + carpetImages.length) % carpetImages.length);
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Hygienic cleaning and sanitization of carpets to eliminate odors and bacteria. Keep your carpets 
                clean and fresh with our professional carpet cleaning service.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Complete sanitization and cleaning service to keep your carpets hygienic and odor-free.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="font-playfair text-3xl md:text-4xl font-bold text-[#333] mb-4">
                Professional Carpet Cleaning Gallery
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                See how our cleaning service transforms dirty carpets into clean, sanitized containers.
              </p>
            </div>
              ...
              >
                <div className="relative bg-white rounded-xl overflow-hidden">
                  <div className="aspect-[3/2] relative cursor-zoom-in group">
                    <img
                      src={carpetImages[currentImageIndex].src}
                      alt={carpetImages[currentImageIndex].alt}
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Weekly, bi-weekly, or monthly cleaning schedules to keep your carpets consistently clean.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-2">
                <div className="text-center">
                  <h2 className="font-playfair text-3xl md:text-4xl font-bold text-[#333] mb-6">
                    Why Choose Næstir Carpet Cleaning?
                  </h2>
                  <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
                    Professional bin cleaning service that eliminates odors, bacteria, and unsanitary conditions. 
                    Keep your property clean and healthy with regular carpet maintenance.
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Read reviews from satisfied customers who choose our carpet cleaning service.
              </p>
            </div>
              ...
              {[
                {
                  name: "Maria Santos",
                  rating: 5,
                  review: "Finally no more smelly carpets! The team does a thorough job and the carpets stay fresh for weeks.",
                ...
                },
                {
                  ...
                  rating: 5,
                  review: "Essential service for our business. They keep our commercial carpets clean and odor-free, which is crucial for health standards.",
        ...
        <section className="py-20 bg-gradient-to-r from-[#4B0082] to-purple-600 text-white">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl mb-8 opacity-90">
              Book your carpet cleaning service today and eliminate odors and bacteria for good.
            </p>
