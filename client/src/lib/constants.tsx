...
export const reviewsData = [
  {
    ...
    rating: 5,
    comment: "Exceptional service! The team was punctual, professional, and left my apartment spotless. I've been using Næstir for 6 months now and couldn't be happier.",
    date: "2 weeks ago"
  },
  {
    id: 2,
    ...
    rating: 5,
    comment: "Our office has never looked better! Næstir's corporate cleaning service is reliable and thorough. They work around our schedule without any disruption.",
    date: "1 month ago"
  },
  {
    id: 3,
    ...
    service: "Car Wash",
    rating: 5,
    comment: "Amazing car detailing service! My car looks brand new after their premium wash and interior cleaning. Definitely worth every penny.",
    date: "3 weeks ago"
  },
  {
    id: 4,
    ...
    customerInitials: "DL",
    service: "Blocks Cleaning",
    rating: 5,
    comment: "As a building manager, I rely on Næstir for our common area cleaning. They're consistently reliable and our residents appreciate the spotless condition of our lobby and hallways.",
    date: "1 week ago"
  },
  {
    id: 5,
    ...
    customerInitials: "RG",
    service: "Garbage Can Cleaning",
    rating: 5,
    comment: "Never thought I needed this service until I tried it! They completely eliminated the odors from our garbage bins. Now it's a regular monthly service for us.",
    date: "2 months ago"
  },
  {
    id: 6,
    ...
    service: "Apartment Cleaning",
    rating: 5,
    comment: "Professional and thorough cleaning every time. The team is respectful of our home and always exceeds expectations. Highly recommend!",
    date: "1 month ago"
  }
];
