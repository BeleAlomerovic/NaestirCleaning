...
export default function CarpetCleaning() {
  ...
  const serviceFeatures = [
    "Deep steam cleaning for all carpet types",
        ...
        <div className="bg-gray-50 py-4">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-gray-400">/</span>
              <span className="text-[#4B0082] font-medium">Carpet Cleaning</span>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Transform your carpet into a spotless sanctuary with our comprehensive cleaning service. 
