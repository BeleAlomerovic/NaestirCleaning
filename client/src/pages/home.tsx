  ...
  return (
    <PageTransition>
      <div className="min-h-screen">
        ...
        {/* Before & After Section - Single Item Carousel */}
        <section 
          ref={galleryAnimation.elementRef as any}
          className="relative bg-gradient-to-b from-[#F4F1FB] to-white py-20 overflow-hidden"
        >
          <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${galleryAnimation.isVisible ? 'visible' : ''}`}>
            {/* Section Header */}
            <div className="text-center mb-12">
              <h2 className="font-serif text-4xl font-light text-[#2D2D2D] mb-4 tracking-wide">
                Fyrir & Eftir
              </h2>
              <p className="text-[#7A7A7A] text-lg max-w-2xl mx-auto leading-relaxed">
                Witness the remarkable transformations our professional cleaning services deliver
              </p>
            </div>
