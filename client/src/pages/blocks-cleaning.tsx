...
export default function BlocksCleaning() {
  ...
  const blocksImages = [
    {
      src: "data:image/svg+xml;base64,",
      alt: "Professional blocks cleaning result"
    },
    {
      src: "data:image/svg+xml;base64,",
      alt: "Clean blocks interior"
    }
  ];

  const serviceFeatures = [
    "Common area deep cleaning and sanitization",
    "Stairwells: railings, steps, and landing areas",
    "Lobby and entrance hall maintenance",
    "Elevator cleaning and polishing",
    "Parking areas and garage cleaning",
    "Exterior building facade cleaning",
    "Waste disposal area sanitization",
    "Emergency exit and safety area maintenance"
  ];

  const nextImage = () => {
    setCurrentImageIndex((prev) => (prev + 1) % blocksImages.length);
  };

  const prevImage = () => {
    setCurrentImageIndex((prev) => (prev - 1 + blocksImages.length) % blocksImages.length);
  };

  if (currentImageIndex >= blocksImages.length) {
        ...
        <section className="relative bg-gradient-to-br from-[#F8F6FB] via-white to-[#F0E6FF] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Professional Blocks Cleaning Services
              </h1>
              <p 
              ...
              >
                Comprehensive cleaning for apartment blocks, common areas, and residential complexes. 
                We maintain pristine shared spaces that residents are proud to call home.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[80vh]">
              ...
              <div className="lg:col-span-5 space-y-12 pr-8 border-r border-gray-100">
                ...
                <div>
                  ...
                  >
                    What's Included in Your Blocks Clean
                  </h2>
                ...
                >
                  <div className="relative bg-white rounded-xl overflow-hidden">
                    <div className="aspect-[4/3] relative cursor-zoom-in group">
                      <img
                        src={blocksImages[currentImageIndex].src}
                        alt={blocksImages[currentImageIndex].alt}
