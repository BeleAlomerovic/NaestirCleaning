...
export default function CarpetCleaning() {
  ...
  const carpetImages = [
    {
      src: "data:image/svg+xml;base64,",
      alt: "Professional carpet cleaning result"
    },
    {
      src: "data:image/svg+xml;base64,",
      alt: "Clean carpet interior"
    }
  ];

  const serviceFeatures = [
    "Deep steam cleaning and extraction",
    "Stain removal and pre-treatment",
    "Pet odor elimination and sanitization",
    "High-traffic area restoration",
    "Spot cleaning and maintenance",
    "Carpet fiber protection treatment",
    "Quick-dry technology for faster results",
  ...
  if (currentImageIndex >= carpetImages.length) {
        ...
        <section className="relative bg-gradient-to-br from-[#F8F6FB] via-white to-[#F0E6FF] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                Expert carpet cleaning using advanced steam extraction and eco-friendly solutions. 
                We restore your carpets to their original beauty while eliminating stains, odors, and allergens.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[80vh]">
              ...
              <div className="lg:col-span-5 space-y-12 pr-8 border-r border-gray-100">
                ...
                <div>
                  ...
                  >
                    What's Included in Your Carpet Clean
                  </h2>
